...
/**
 * Class to render a segment with both endpoints as grid coordinates points (line, column)
 * **/
public class GridSegment : UVQuad
{
    ...
    protected override void Update()
    {
            ...
            m_prevEndPointGrid != m_endPointGrid)
        {
            ...
            this.transform.localPosition = MathUtils.BuildVector3FromVector2(segmentCenter, 0);
